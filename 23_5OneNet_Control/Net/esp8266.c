...
void ESP8266_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;	//GPIOA0-复位
	...
	while(ESP8266_SendCmd("AT+RST\r\n\r", "OK", 200))
		Delay_ms(500);	
	Serial_Printf("CWMODE\r\n");
	while(ESP8266_SendCmd("AT+CWMODE=1\r\n", "OK", 200))
		Delay_ms(500);
	
	Serial_Printf("AT+CWDHCP\r\n");
